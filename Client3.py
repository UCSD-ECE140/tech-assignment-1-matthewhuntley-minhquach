...
client = paho.Client(callback_api_version=paho.CallbackAPIVersion.VERSION1, client_id="subscriber", userdata=None, protocol=paho.MQTTv5)
...
client.username_pw_set("subscriber1", "Techassignment1")
